...
class Wwww3qDatzBaseConnectSample extends Sample {
  Wwww3qDatzBaseConnectSample() : super('lib/app/core/base/base_connect.dart', overwrite: true);
...
class Wwww3qDatzBaseControllerSample extends Sample {
  Wwww3qDatzBaseControllerSample() : super('lib/app/core/base/base_controller.dart', overwrite: true);
...
class Wwww3qDatzBaseModelSample extends Sample {
  Wwww3qDatzBaseModelSample() : super('lib/app/core/base/base_model.dart', overwrite: true);
...
class Wwww3qDatzBaseProjectSample extends Sample {
  Wwww3qDatzBaseProjectSample() : super('lib/app/core/base/base_project.dart', overwrite: true);
